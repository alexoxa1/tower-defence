    ...
    makeCanvas(512, 90211, (data, noise, size) => {
      for (let y = 0; y < size; y += 1) {
        for (let x = 0; x < size; x += 1) {
          ...
          const ash = (n + 1) * 0.5;
          const r = 12 + ash * 38 + grit * 8 - crack * 22;
          const g = 11 + ash * 34 + grit * 6 - crack * 20;
          const b = 14 + ash * 42 + grit * 10 - crack * 18;
          const amber = grit > 0.62 ? (grit - 0.62) * 18 : 0;
          const i = (y * size + x) * 4;
    ...
    makeCanvas(512, 44021, (data, noise, size) => {
      for (let y = 0; y < size; y += 1) {
        for (let x = 0; x < size; x += 1) {
          ...
          const wear = (n + 1) * 0.5;
          const r = 22 + wear * 28 + scratch * 40;
          const g = 20 + wear * 24 + scratch * 28;
          const b = 18 + wear * 20 + scratch * 16;
          const i = (y * size + x) * 4;
